...
$CONF['admin_email'] = 'admin@sqa.net.pl';
...
$CONF['default_aliases'] = array (
    'abuse' => 'abuse@qa.net.pl',
    'hostmaster' => 'hostmaster@qa.net.pl',
    'postmaster' => 'postmaster@qa.net.pl',
    'webmaster' => 'webmaster@qa.net.pl'
);
...
$CONF['vacation_domain'] = 'autoreply.qa.net.pl';
...
$CONF['footer_text'] = 'Return to qa.net.pl';
$CONF['footer_link'] = 'http://qa.net.pl';
